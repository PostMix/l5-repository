 ...
 * @author Pavel Savushkin <pavel.savushkin.mix@gmail.com>
 */
class ProjectCommand extends Command
{
    /**
     * Methods of API
     * Need for generating tests
     */
    const API_METHODS = ['Create', 'Update', 'Read', 'Delete'];
     ...
     * @var string
     */
    protected $description = 'Generate a project parts based on configuration schema.';
    ...
    public function fire()
    {
        ...
        foreach (self::API_METHODS as $apiMethod) {
            $this->call('make:test', [
                'name' => $this->argument('name') . '\\' . $apiMethod,
                '--unit' => null,
            ]);
        }
    }
